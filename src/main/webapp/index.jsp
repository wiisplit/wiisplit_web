...
<!-- //for-mobile-apps -->
<link href="static/custom/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="static/custom/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="static/custom/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="#how_it_works" class="hvr-bounce-to-bottom">How It Works</a></li>
								<li><a href="#testimonials" class="hvr-bounce-to-bottom">Testimonials</a></li>
								<li><a href="short-codes.html" class="hvr-bounce-to-bottom">Sign Up</a></li>
...
<div class="events" id="how_it_works">
		<div class="container">
			...
			<p class="autem">Getting an Internet connection has never been affordable before</p>
			<div class="events-grids">
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="single.html"><img src="static/custom/images/hiw1.png" alt=" " class="img-responsive" /></a>
						<h4><a href="#">Find a Wifi</a></h4>
					<!--	<ul>
						...
						<p>Now you can enter your accurate location and choose someone willing to share their Internet connection.</p>
					</div>
				</div>
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="single.html"><img src="static/custom/images/hiw2.png" alt=" " class="img-responsive" /></a>
						<h4><a href="#">Get in Touch</a></h4>
					<!--	<ul>
							<li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admin</a></li>
							<li><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>May 25, 2016</li>
						</ul> -->
						<p>Just click on the user's account and get all the details of the connection. 
						You can also message any of the trusted profile across the platform.</p>
					</div>
				</div>
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="#"><img src="static/custom/images/hiw3.png" alt=" " class="img-responsive" /></a>
						<h4><a href="single.html">Share and Save</a></h4>
					<!--	<ul>
							<li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admin</a></li>
							<li><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>May 30, 2016</li>
						</ul>  -->
						<p>Make your Internet connection affordable by sharing your connection with people living nerarby.</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
						...
						<div class="wmuSliderWrapper">
								...
								<div class="banner-wrap">
									<div class="testimonials-grid-left-grid">
										<div class="testimonials-grid-left1">
											<img src="static/custom/images/1.png" alt=" " class="img-responsive" />
										</div>
									...
									<div class="testimonials-grid-left-grid">
										<div class="testimonials-grid-left1">
											<img src="static/custom/images/2.png" alt=" " class="img-responsive" />
										</div>
										<div class="testimonials-grid-left2">
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="testimonials-grid-left-grid">
										<div class="testimonials-grid-left1">
											<img src="static/custom/images/3.png" alt=" " class="img-responsive" />
										</div>
										<div class="testimonials-grid-left2">
											<h4>ut aut reiciendis voluptatibus maiores alias consequatur aut 
												perferendis doloribus asperiores repellat</h4>
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid">
					<div class="footer-grid1">
						<div class="footer-grid1-left">
							<a href="single.html"><img src="static/custom/images/7.jpg" alt=" " class="img-responsive"></a>
						</div>
					...
					<div class="footer-grid1">
						<div class="footer-grid1-left">
							<a href="#"><img src="static/custom/images/6.jpg" alt=" " class="img-responsive"></a>
						</div>
						<div class="footer-grid1-right">
					...
					<div class="footer-grid1">
						<div class="footer-grid1-left">
							<a href="#"><img src="static/custom/images/8.jpg" alt=" " class="img-responsive"></a>
						</div>
						<div class="footer-grid1-right">
				...
				<div class="col-md-3 footer-grid">
					<div class="footer-grid-instagram">
						<a href="#"><img src="static/custom/images/9.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-instagram">
						<a href="#"><img src="static/custom/images/10.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-instagram">
						<a href="#"><img src="static/custom/images/6.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-instagram">
						<a href="#"><img src="static/custom/images/7.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
